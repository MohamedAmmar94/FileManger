<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @endcan
        @can('invitable_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.invitables.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/invitables") || request()->is("admin/invitables/*") ? "c-active" : "" }}">
                    <i class="fa-fw fas fa-ticket-alt c-sidebar-nav-icon">

                    </i>
                    {{ trans('cruds.invitable.title') }}
                </a>
            </li>
        @endcan
